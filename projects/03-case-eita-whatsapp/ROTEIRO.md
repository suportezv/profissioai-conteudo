...
|---|---|---|---|---|
| **01** | 0:00 a 0:11 | Plano filmado: mão segurando o celular, luz quente de abajur, bokeh ao fundo. O **campo de digitação levanta da tela em 3D** e a pessoa escreve **não estou bem**, hesita, **apaga**. Escreve **preciso falar com alguém**, hesita, apaga. Escreve **não sei mais o que fazer** e para. O cursor fica piscando. **Nada é enviado.** | ninguém, depois narração entra baixa | *(4 s de silêncio: só o teclado)*<br><br>**Narração:** Todo dia, milhões de brasileiros escrevem uma mensagem assim. E a maioria nunca manda pra ninguém. |
...
| **03** | 0:24 a 0:40 | Linha do tempo de 1px com 2017, 2020 e 2024. Sob cada ano, a lista do que era e do que é, com ícone. | **Narração Profissio** | Ela já tinha tentado em 2017, antes da IA generativa existir. Um app que dependia de psicólogos catalogando sentimentos à mão. Não sobreviveu à pandemia. Em 2024 ela voltou. |
...
| **07** | 1:28 a 1:41 | Mesmo tratamento da cena 01, agora no plano frio: alguém na cama, no escuro, com o display estourado de branco. **O rascunho que tinha ficado parado no campo aparece enviado**, com dois checks que viram azuis. Um áudio levanta do mesmo display e toca, com a onda andando. Corta para a Anaclaudia ouvindo a própria voz. | **áudio do produto**, depois **Sonora Anaclaudia** | O áudio toca na voz clonada dela. *(usar áudio real do produto, aprovado)*<br><br>**Pergunta:** *O que você sentiu ao ouvir sua própria voz respondendo alguém que você nunca vai conhecer?* |
...
**Nenhuma conversa real na tela.** Os balões e o campo de digitação são todos recriados em motion, e o plano embaixo deles é filmado, nunca captura de tela de usuário. As únicas frases que o espectador lê inteiras são os três rascunhos da cena 01. A grade da cena 08 é desfocada a ponto de ser textura.

**O balão levanta, a tela não é mostrada.** As cenas 01 e 07 não desenham o app: mostram a pessoa e deixam o texto sair do display em perspectiva. A escolha muda o que a cena diz, de "print de conversa" para "a frase existe no mundo".

**O arco das duas cenas é o filme inteiro em miniatura, e depende de uma frase.** Na 01 a pessoa escreve três desabafos e apaga dois; o terceiro, **não sei mais o que fazer**, fica parado no campo sem ser enviado. Na 07 é **esse mesmo texto** que aparece enviado, com dois checks, e respondido. Trocar a frase de uma sem trocar a da outra quebra o arco, e por isso as duas estão comentadas no código apontando uma para a outra.

**Na cena 01 o botão de enviar aparece e nunca é tocado.** É o ponto da cena: não é que a mensagem não foi entregue, é que ela nem chegou a ser mandada. A narração que entra depois ("e a maioria nunca manda pra ninguém") passa a ter imagem em vez de ilustração.
...
| Plano filmado da cena 01 (mão, celular, luz quente) | 01 | **pronto**: gerado em Veo, `broll/mood-07-audio-maos.mp4` |
| Plano filmado da cena 07 (pessoa na cama, celular) | 07 | **pronto**: gerado em Veo, `broll/mood-01-abertura.mp4` |
| Campo de digitação e balões em 3D levantando do display | 01, 07 | **prontos**: `CaseEitaCena01` e `CaseEitaCena07` |
